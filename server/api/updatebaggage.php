...
if ($method === 'POST') {
    ...
    $flight_number = mysqli_real_escape_string($con, $data['flight_number']);
    ...
    $fids_update_sql = "UPDATE baggage_table SET status = '$status', first_bag = NOW() WHERE flight_number = '$flight_number'";
